...
<link href="/css/qra/qraSearch.css" rel="stylesheet">
<style type="text/css">
.c_title{
...
<%
ArrayList<QraDto> dtos = (ArrayList)request.getAttribute("search");
...
<div class="clear"></div>
<form action="/dao/QraSearch" method="post">
	<select name="gk">
	...
	<input type="text" id = "msg" name="title">

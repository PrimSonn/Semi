...
<div class="paynav">
	<a href ="/payHistory/payHistory01.jsp" >결제내역</a> | <a href ="/payHistory/payHistory02.jsp" >취소내역</a>
</div>	
<table class="p_body1">
	<tr >
		<td class ="item1">날짜</td>
		<td class ="item2">내역</td>
		<td class ="item3">결제금액</td>
		<td class ="item4">상태</td>
	</tr>
</table>
<%
	PayHistoryDao paydao = new  PayHistoryDao();
	ArrayList<PayHistoryDto> dtos = (ArrayList)request.getAttribute("search");
